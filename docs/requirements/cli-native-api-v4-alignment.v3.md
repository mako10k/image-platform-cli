# CLI to Native API V4 replacement requirements, document revision 3

- Status: `DRAFT_FOR_FIRST_OWNER_REVIEW`
- Date: 2026-09-09
- API major version: `4`
- Requirement document revision: `3`
- Lifecycle phase: step 1 complete
- Replaces after acceptance: unaccepted revision 2
...
| Reviewed predecessor | `docs/requirements/cli-native-api-v4-alignment.v2.md` | `366fee5f10e0662957e7a263dc3218c879d06f844bd4216a9c67e305751587d5` |
